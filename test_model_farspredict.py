...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='FarsPredict', 
                        help='Dataset: {FB15k-237, YAGO3-10, WN18RR, umls, nations, kinship}')
    parser.add_argument('--model-path', type=str, default='saved_models/FarsPredict_conve_0.2_0.3.epoch_281.model',
